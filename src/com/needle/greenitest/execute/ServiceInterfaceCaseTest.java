package com.needle.greenitest.execute;
...
import com.needle.greenitest.client.HttpInvokerServiceClientImpl;
import com.needle.greenitest.client.HttpServiceClientImpl;
import com.needle.greenitest.client.JsonRpcServiceClientImpl;
import com.needle.greenitest.client.ServiceInterfaceClient;
import com.needle.greenitest.client.SoapServiceClientImpl;
import com.needle.greenitest.dto.*;
import com.needle.greenitest.login.*;
import com.needle.greenitest.parser.CaseFolderParser;
import com.needle.greenitest.parser.CaseFolderParserImpl;
import com.needle.greenitest.setup.SetUp;
import com.needle.greenitest.setup.SetUpImpl;
import com.needle.greenitest.teardown.TearDown;
import com.needle.greenitest.teardown.TearDownImpl;
import com.needle.greenitest.util.*;
import com.needle.greenitest.verify.Verify;
import com.needle.greenitest.verify.VerifyImpl;
...
public class ServiceInterfaceCaseTest {
	...
	/**
	 * CASEPATH为外部case的路径，默认的是project的case目录(无casesuite二级目录)，
	 * 如果test.properties中指定二级目录则替换
	 */

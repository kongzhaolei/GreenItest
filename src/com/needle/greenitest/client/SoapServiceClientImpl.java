...
public class SoapServiceClientImpl implements ServiceInterfaceClient {

		private static Log log = LogFactory.getLog(SoapServiceClientImpl.class);

		public Object invokeServiceMethod(CaseData casedata, Config config) {
			String caseAction = casedata.getAction();
			...
			return requestSoap(caseAction,casedata.getInputFile(),config,casedata.getVarGen());
		}
		
		
		
		private Object requestSoap(File file, Config config, VariableGenerator vargen) {
		...
		private String sendSoapViaHttps(String hosturl,String ip, int port, String action,
